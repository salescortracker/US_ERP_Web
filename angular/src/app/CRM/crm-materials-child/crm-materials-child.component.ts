...
@Component({
  selector: 'app-crm-materials-child',
  templateUrl: './crm-materials-child.component.html',
  styleUrls: ['./crm-materials-child.component.scss']
})
export class CrmMaterialsChildComponent implements OnInit {
