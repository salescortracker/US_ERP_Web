...
@Component({
  selector: 'app-crm-quotation-create',
  templateUrl: './crm-quotation-create.component.html',
  styleUrls: ['./crm-quotation-create.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class CrmQuotationCreateComponent implements OnInit {
