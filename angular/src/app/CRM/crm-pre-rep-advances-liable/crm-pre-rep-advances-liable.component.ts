...
@Component({
  selector: 'app-crm-pre-rep-advances-liable',
  templateUrl: './crm-pre-rep-advances-liable.component.html',
  styleUrls: ['./crm-pre-rep-advances-liable.component.scss']
})
export class CrmPreRepAdvancesLiableComponent implements OnInit {
  public details:any;
