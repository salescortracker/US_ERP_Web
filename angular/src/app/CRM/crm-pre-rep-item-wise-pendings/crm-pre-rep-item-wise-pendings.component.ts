...
@Component({
  selector: 'app-crm-pre-rep-item-wise-pendings',
  templateUrl: './crm-pre-rep-item-wise-pendings.component.html',
  styleUrls: ['./crm-pre-rep-item-wise-pendings.component.scss']
})
export class CrmPreRepItemWisePendingsComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.ckey.getItemWisePendingOrders().subscribe(
      async res => {
