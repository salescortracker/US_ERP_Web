...
@Component({
  selector: 'app-crm-post-rep-sale-returns',
  templateUrl: './crm-post-rep-sale-returns.component.html',
  styleUrls: ['./crm-post-rep-sale-returns.component.scss']
})
export class CrmPostRepSaleReturnsComponent implements OnInit {
  public details:any;
