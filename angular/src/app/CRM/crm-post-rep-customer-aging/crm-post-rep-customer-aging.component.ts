...
@Component({
  selector: 'app-crm-post-rep-customer-aging',
  templateUrl: './crm-post-rep-customer-aging.component.html',
  styleUrls: ['./crm-post-rep-customer-aging.component.scss']
})
export class CrmPostRepCustomerAgingComponent implements OnInit {
  public parties:any;
