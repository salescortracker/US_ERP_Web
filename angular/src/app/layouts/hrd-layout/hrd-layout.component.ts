...
import {HrdMenuComponent} from 'app/shared/hrd-menu/hrd-menu.component';


@Component({
  selector: 'app-hrd-layout',
  templateUrl: './hrd-layout.component.html',
  styleUrls: ['./hrd-layout.component.scss']
})
export class HrdLayoutComponent implements OnInit {
