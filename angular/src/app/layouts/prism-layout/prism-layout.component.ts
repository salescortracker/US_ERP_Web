...
import {PrismMenuComponent} from 'app/shared/prism-menu/prism-menu.component';

@Component({
  selector: 'app-prism-layout',
  templateUrl: './prism-layout.component.html',
  styleUrls: ['./prism-layout.component.scss']
})
export class PrismLayoutComponent implements OnInit {
