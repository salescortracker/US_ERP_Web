...
@Component({
  selector: 'app-hrd-employees-details',
  templateUrl: './hrd-employees-details.component.html',
  styleUrls: ['./hrd-employees-details.component.scss']
})
export class HrdEmployeesDetailsComponent implements OnInit {
