...
@Component({
  selector: 'app-hrd-dash-board',
  templateUrl: './hrd-dash-board.component.html',
  styleUrls: ['./hrd-dash-board.component.scss']
})
export class HrdDashBoardComponent implements OnInit {
  ...
  constructor() {
    ...
    this.lineChartOptions = {
      ...
      series: [{
        name: "Desktops",
        data: [50, 41, 35, 51, 49, 62],
      }],
      title: {
        text: 'Salaries of last 6 months in thousands',
        align: 'left'
      },
      grid: {
        row: {
    ...
    this.columnChartOptions = {
      ...
      series: [ {
        name: 'Joinings',
        data: [76, 85, 101, 98, 87, 105, 91, 114, 94,72,65,66]
      },{
        name: 'Closings',
        data: [44, 55, 57, 56, 61, 58, 63, 60, 66,25,52,44]
      }],
      legend: {
        offsetY: -10
      },
    ...
    this.pieChartOptions = {
      ...
      colors: themeColors,
      labels: ['Production', 'Despatches', 'Administration', 'Marketing'],
      series: [44, 55, 13, 43],
      legend: {
        itemMargin: {
          horizontal: 2
    ...
    this.donutChartOptions = {
      ...
      colors: themeColors,
      labels: ['Workers', 'Marketing', 'Accountant', 'Manager'],
      series: [44, 55, 41, 17],
      legend: {
        itemMargin: {
          horizontal: 2
