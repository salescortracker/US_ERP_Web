...
@Component({
  selector: 'app-sal-rep-list-of-sales',
  templateUrl: './sal-rep-list-of-sales.component.html',
  styleUrls: ['./sal-rep-list-of-sales.component.scss']
})
export class SalRepListOfSalesComponent implements OnInit {
  ...
  constructor(private sal:SaleReportsService,private adm:AdminGeneralInfoService,
   ...
   listAdd()
   {
     ...
     this.sal.getListOfSales(this.adm.strDate(this.fromdate),this.adm.strDate(this.todate)).subscribe(
       async res => {
         var det:any=res;
         console.log(det);
         if(det)
