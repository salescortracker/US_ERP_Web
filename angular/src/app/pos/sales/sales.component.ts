...
public poseq:string='BILL2223-00001';
public items:any={};
public material:any={
  grp: '',
itemcode: '',
   ...
   var header:any=
      {
        ...
        Validity:this.adm.strDate(this.validitydate),
      ...
      for(var i=0;i<this.items.length;i++)
        {
          lines.push({
            ...
            Um:this.items[i].umid,
            Rat:this.items[i].rat
...
public ShowOrders()
{
  ...
  var dat2=dat1;
  this.ino.GetInvPurchaseOrders(dat1,dat2,'Sale').subscribe(res =>
    {
