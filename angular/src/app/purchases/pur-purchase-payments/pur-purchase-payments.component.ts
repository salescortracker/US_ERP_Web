...
export class PurPurchasePaymentsComponent implements OnInit {
  ...
  public revereseAccount:number=0;
    ...
    if(this.adm.screenCheck(2,3,4,2)){
    this.modifybuttonenable=true;
    }
    else{
     this.modifybuttonenable=false;
    }
    if(this.adm.screenCheck(2,3,4,3)){
  ...
  public listAdd()
  {
    this.spinner.show(undefined,
      ...
      this.pur.getPayments(this.adm.strDate(this.fromdate),this.adm.strDate(this.todate)).subscribe(res =>
        {
            this.receipts=res;
            this.spinner.hide();
        });
