...
@Component({
  selector: 'app-pur-rep-order-management-delayed-orders',
  templateUrl: './pur-rep-order-management-delayed-orders.component.html',
  styleUrls: ['./pur-rep-order-management-delayed-orders.component.scss']
})
export class PurRepOrderManagementDelayedOrdersComponent implements OnInit {
