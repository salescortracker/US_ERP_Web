...
@Component({
  selector: 'app-pur-rep-stock-day-book',
  templateUrl: './pur-rep-stock-day-book.component.html',
  styleUrls: ['./pur-rep-stock-day-book.component.scss']
})
export class PurRepStockDayBookComponent implements OnInit {
  public details:any;
  ...
  constructor(private pur:PurRepStocksService,private adm:AdminGeneralInfoService,
   ...
   listAdd()
   {
     ...
     this.pur.getPurchasesDayBook(this.adm.strDate(this.fromdate)).subscribe(
       async res => {
         var det:any=res;
         console.log(det);
         if(det)
