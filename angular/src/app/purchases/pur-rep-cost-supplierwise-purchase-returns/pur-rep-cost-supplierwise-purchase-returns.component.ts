...
@Component({
  selector: 'app-pur-rep-cost-supplierwise-purchase-returns',
  templateUrl: './pur-rep-cost-supplierwise-purchase-returns.component.html',
  styleUrls: ['./pur-rep-cost-supplierwise-purchase-returns.component.scss']
})
export class PurRepCostSupplierwisePurchaseReturnsComponent implements OnInit {
  public details:any;
