...
public listdat:Date=new Date();
  ...
  constructor(private acc:AccAccountsService,private adm:AdminGeneralInfoService,private ino:PurPurchaseQuotationService,
    private modalService: NgbModal,private enq:PurPurchaseEnquiryService, private ord:InvPurchaseOrderService,private par:PartyDetailsService,
...
if(this.adm.screenCheck(2,2,5,9)){
              ...
              if(det.result=='OK')
            {
              ...
              if(sup.length > 0)
              {
               ...
               // this.refQuo=header.refQuotation;
                ...
                this.salesorder=header.salesorder;
                this.itemdetails=[];
...

{
 ...
 this.ord.GetInvPurchaseOrders(this.adm.strDate(this.fromdate),this.adm.strDate(this.todate),'PO').subscribe(res =>
