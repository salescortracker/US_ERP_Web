...
@Component({
  selector: 'app-pur-rep-cost-supplier-aging',
  templateUrl: './pur-rep-cost-supplier-aging.component.html',
  styleUrls: ['./pur-rep-cost-supplier-aging.component.scss']
})
export class PurRepCostSupplierAgingComponent implements OnInit {
  public parties:any;
  ...
  listAdd()
  {
    ...
    this.pur.getSupplierAgingDetails().subscribe(
      async res => {
        var det:any=res;
