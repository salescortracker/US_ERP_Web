...
@Component({
  selector: 'app-pur-purchases-temp',
  templateUrl: './pur-purchases-temp.component.html',
  styleUrls: ['./pur-purchases-temp.component.scss']
})
export class PurPurchasesTempComponent implements OnInit {
...
public ShowOrders()
{
  ...
  var dat2=dat1;
  this.ino.GetInvPurchaseOrders(dat1,dat2,'PUR').subscribe(res =>
    {
...
ConfirmText() {
  Swal.fire({  
    title: 'Confirms Purchase Order Details',  
    text: 'You will not be able to recover this file!',  
    icon: 'warning',  
    showCancelButton: true,  
    confirmButtonText: 'Yes, confirm it!',  
