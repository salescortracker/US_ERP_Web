...
@Component({
  selector: 'app-pur-rep-cost-list-of-notes',
  templateUrl: './pur-rep-cost-list-of-notes.component.html',
  styleUrls: ['./pur-rep-cost-list-of-notes.component.scss']
})
export class PurRepCostListOfNotesComponent implements OnInit {
  public details:any;
  ...
  constructor(private pur:PurRepPurchasesService,private adm:AdminGeneralInfoService,
   ...
   listAdd()
   {
     ...
     this.pur.purRepPurchaseCreditNotes(this.adm.strDate(this.fromdate),this.adm.strDate(this.todate)).subscribe(
       async res => {
         var det:any=res;
         console.log(det);
         if(det)
