...
@Component({
  selector: 'app-pur-rep-order-management-list-of-orders',
  templateUrl: './pur-rep-order-management-list-of-orders.component.html',
  styleUrls: ['./pur-rep-order-management-list-of-orders.component.scss']
})
export class PurRepOrderManagementListOfOrdersComponent implements OnInit {
