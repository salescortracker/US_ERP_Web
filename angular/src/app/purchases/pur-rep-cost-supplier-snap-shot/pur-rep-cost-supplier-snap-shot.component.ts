...
@Component({
  selector: 'app-pur-rep-cost-supplier-snap-shot',
  templateUrl: './pur-rep-cost-supplier-snap-shot.component.html',
  styleUrls: ['./pur-rep-cost-supplier-snap-shot.component.scss']
})
export class PurRepCostSupplierSnapShotComponent implements OnInit {
  public parties:any;
  ...
  listAdd()
  {
    ...
    this.pur.getSupplierSnapShot().subscribe(
      async res => {
        var det:any=res;
