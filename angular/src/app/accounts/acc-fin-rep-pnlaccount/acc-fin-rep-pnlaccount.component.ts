...
@Component({
  selector: 'app-acc-fin-rep-pnlaccount',
  templateUrl: './acc-fin-rep-pnlaccount.component.html',
  styleUrls: ['./acc-fin-rep-pnlaccount.component.scss']
})
export class AccFinRepPNLAccountComponent implements OnInit {
  ...
  public listAdd()
  {
    this.spinner.show(undefined,
      ...
      this.ack.getPNLAccount(str).subscribe(res =>
        {
console.log(res);
var det:any=res;
