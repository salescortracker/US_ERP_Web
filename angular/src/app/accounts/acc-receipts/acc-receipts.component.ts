...
//this.authCheck=false;
   ...
   ngOnInit(): void {
     if(this.adm.screenCheck(1,2,2,1)){
       this.addbuttonenable=true;
     }
     else{
        this.addbuttonenable=false;
     }
     if(this.adm.screenCheck(1,2,2,2)){
      this.modifybuttonenable=true;
    }
    else{
       this.modifybuttonenable=false;
    }
    if(this.adm.screenCheck(1,2,2,3)){
...
listAdd()
{
  this.spinner.show(undefined,
    ...
    this.act.getListOfTransactions('Receipt',this.adm.strDate(this.fromdate),this.adm.strDate(this.todate)).subscribe(res =>
      {
