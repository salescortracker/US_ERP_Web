...
@Component({
  selector: 'app-acc-key-rep-accounts',
  templateUrl: './acc-key-rep-accounts.component.html',
  styleUrls: ['./acc-key-rep-accounts.component.scss']
})
export class AccKeyRepAccountsComponent implements OnInit {
  public accs:any;
  ...
  listAdd()
  {
    ...
    this.akey.getKeyAccountDetails().subscribe(
      async res => {
        var det:any=res;
