...
@Component({
  selector: 'app-inv-key-rep-item-groups',
  templateUrl: './inv-key-rep-item-groups.component.html',
  styleUrls: ['./inv-key-rep-item-groups.component.scss']
})
export class InvKeyRepItemGroupsComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.akey.getKeyRepItemGroups().subscribe(
      async res => {
        var det:any=res;
