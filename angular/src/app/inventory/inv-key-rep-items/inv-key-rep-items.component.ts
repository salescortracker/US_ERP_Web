...
@Component({
  selector: 'app-inv-key-rep-items',
  templateUrl: './inv-key-rep-items.component.html',
  styleUrls: ['./inv-key-rep-items.component.scss']
})
export class InvKeyRepItemsComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.akey.getKeyRepItems().subscribe(
      async res => {
        var det:any=res;
