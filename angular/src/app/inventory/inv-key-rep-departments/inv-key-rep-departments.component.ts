...
@Component({
  selector: 'app-inv-key-rep-departments',
  templateUrl: './inv-key-rep-departments.component.html',
  styleUrls: ['./inv-key-rep-departments.component.scss']
})
export class InvKeyRepDepartmentsComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.akey.getKeyRepDepartments().subscribe(
      async res => {
        var det:any=res;
