...
@Component({
  selector: 'app-inv-key-rep-stores',
  templateUrl: './inv-key-rep-stores.component.html',
  styleUrls: ['./inv-key-rep-stores.component.scss']
})
export class InvKeyRepStoresComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.akey.getKeyRepStores().subscribe(
      async res => {
        var det:any=res;
