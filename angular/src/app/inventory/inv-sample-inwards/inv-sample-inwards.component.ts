...
export class InvSampleInwardsComponent implements OnInit {
  ...
  public selectedItems:any[]=[];
    ...
    constructor(private pur:PurchasesService, private puo:InvPurchaseOrderService,private par:PartyDetailsService,
  ...
  public showOrder()
  {
   ...
   private getDismissReason(reason: any): string {
    ...
    var dat2=dat1;
    this.pur.getPurchases(dat1,dat2).subscribe(res =>
      {
          this.purchases=res;
           console.log(res);
           this.spinner.hide();
