...
@Component({
  selector: 'app-reppursuppliergroups',
  templateUrl: './reppursuppliergroups.component.html',
  styleUrls: ['./reppursuppliergroups.component.scss']
})
export class ReppursuppliergroupsComponent implements OnInit {
