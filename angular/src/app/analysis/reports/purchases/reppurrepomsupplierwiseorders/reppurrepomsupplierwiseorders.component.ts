...
@Component({
  selector: 'app-reppurrepomsupplierwiseorders',
  templateUrl: './reppurrepomsupplierwiseorders.component.html',
  styleUrls: ['./reppurrepomsupplierwiseorders.component.scss']
})
export class ReppurrepomsupplierwiseordersComponent implements OnInit {
