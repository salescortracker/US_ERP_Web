...
const now = new Date();
@Component({
  selector: 'app-reppurrepomrequests',
  templateUrl: './reppurrepomrequests.component.html',
  styleUrls: ['./reppurrepomrequests.component.scss']
})
export class ReppurrepomrequestsComponent implements OnInit {
  public details:any;
