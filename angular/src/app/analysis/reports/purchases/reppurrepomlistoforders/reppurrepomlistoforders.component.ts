...
@Component({
  selector: 'app-reppurrepomlistoforders',
  templateUrl: './reppurrepomlistoforders.component.html',
  styleUrls: ['./reppurrepomlistoforders.component.scss']
})
export class ReppurrepomlistofordersComponent implements OnInit {
