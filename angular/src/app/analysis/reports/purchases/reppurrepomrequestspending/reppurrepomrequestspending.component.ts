...
@Component({
  selector: 'app-reppurrepomrequestspending',
  templateUrl: './reppurrepomrequestspending.component.html',
  styleUrls: ['./reppurrepomrequestspending.component.scss']
})
export class ReppurrepomrequestspendingComponent implements OnInit {
  public details:any;
