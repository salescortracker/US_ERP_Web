...
@Component({
  selector: 'app-repcrmrepcallerwisecalls',
  templateUrl: './repcrmrepcallerwisecalls.component.html',
  styleUrls: ['./repcrmrepcallerwisecalls.component.scss']
})
export class RepcrmrepcallerwisecallsComponent implements OnInit {
  public details:any;
