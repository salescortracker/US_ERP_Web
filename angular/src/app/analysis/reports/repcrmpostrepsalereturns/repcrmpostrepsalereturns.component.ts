...
@Component({
  selector: 'app-repcrmpostrepsalereturns',
  templateUrl: './repcrmpostrepsalereturns.component.html',
  styleUrls: ['./repcrmpostrepsalereturns.component.scss']
})
export class RepcrmpostrepsalereturnsComponent implements OnInit {
  public details:any;
  ...
  constructor(private pur:CrmRepPostSalesService,private adm:AdminGeneralInfoService,
   ...
   listAdd()
   {
     ...
     this.pur.getSaleReturns(this.adm.strDate(this.fromdate),this.adm.strDate(this.todate)).subscribe(
       async res => {
         var det:any=res;
         console.log(det);
         if(det)
