...
@Component({
  selector: 'app-repcrmpostrepsnapshot',
  templateUrl: './repcrmpostrepsnapshot.component.html',
  styleUrls: ['./repcrmpostrepsnapshot.component.scss']
})
export class RepcrmpostrepsnapshotComponent implements OnInit {
