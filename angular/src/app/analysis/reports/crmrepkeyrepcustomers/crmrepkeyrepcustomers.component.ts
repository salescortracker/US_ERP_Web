...
@Component({
  selector: 'app-crmrepkeyrepcustomers',
  templateUrl: './crmrepkeyrepcustomers.component.html',
  styleUrls: ['./crmrepkeyrepcustomers.component.scss']
})
export class CrmrepkeyrepcustomersComponent implements OnInit {
