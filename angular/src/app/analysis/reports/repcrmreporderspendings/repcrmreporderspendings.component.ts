...
@Component({
  selector: 'app-repcrmreporderspendings',
  templateUrl: './repcrmreporderspendings.component.html',
  styleUrls: ['./repcrmreporderspendings.component.scss']
})
export class RepcrmreporderspendingsComponent implements OnInit {
