...
import { NgxSpinnerService } from "ngx-spinner";
 ...
 const now = new Date();
@Component({
  selector: 'app-repcrmenquiryrx',
  templateUrl: './repcrmenquiryrx.component.html',
  styleUrls: ['./repcrmenquiryrx.component.scss']
})
export class RepcrmenquiryrxComponent implements OnInit {
