...
import { NgxSpinnerService } from "ngx-spinner";
 ...
 const now = new Date();
@Component({
  selector: 'app-repcrmreptelecallslist',
  templateUrl: './repcrmreptelecallslist.component.html',
  styleUrls: ['./repcrmreptelecallslist.component.scss']
})
export class RepcrmreptelecallslistComponent implements OnInit {
  public details:any;
