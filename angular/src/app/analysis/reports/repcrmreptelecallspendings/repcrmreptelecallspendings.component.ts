...
@Component({
  selector: 'app-repcrmreptelecallspendings',
  templateUrl: './repcrmreptelecallspendings.component.html',
  styleUrls: ['./repcrmreptelecallspendings.component.scss']
})
export class RepcrmreptelecallspendingsComponent implements OnInit {
