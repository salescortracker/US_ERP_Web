...
@Component({
  selector: 'app-repcrmrepenquiriespendings',
  templateUrl: './repcrmrepenquiriespendings.component.html',
  styleUrls: ['./repcrmrepenquiriespendings.component.scss']
})
export class RepcrmrepenquiriespendingsComponent implements OnInit {
  public details:any;
