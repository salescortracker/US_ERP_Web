...
@Component({
  selector: 'app-mai-key-rep-equipment-details',
  templateUrl: './mai-key-rep-equipment-details.component.html',
  styleUrls: ['./mai-key-rep-equipment-details.component.scss']
})
export class MaiKeyRepEquipmentDetailsComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.akey.getKeyRepEquipmentDetails().subscribe(
      async res => {
        var det:any=res;
