...
import { AnalysisMenuService } from "app/menus/analysis-menu.service";
...
public branchName:string;
  constructor(
    ...
    private analy:AnalysisMenuService
  ) {
    ...
    this.menuItems=this.analy.getAnalysisHorizontalMenuMake();//ROUTES;
