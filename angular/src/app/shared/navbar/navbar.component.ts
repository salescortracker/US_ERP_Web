...
public branchname:string='';
  ...
  constructor(public translate: TranslateService,
    private layoutService: LayoutService,private adm:AdminGeneralInfoService,
...
//this.branchName=usr.pCode;
    ...
    this.layoutSub = layoutService.toggleSidebar$.subscribe(
      isShow => {
       ...
       this.usr=this.adm.getUserCompleteInformation().usr;
      this.username=this.adm.getUserCompleteInformation().usr.uCode;
      this.branchname=this.adm.getUserCompleteInformation().addr.branchName.toUpperCase();
      this.logopath=this.adm.getActualURL() + "Attachments\\fo\\LOGO_" + this.usr.cCode.toString() + "_" + this.usr.bCode + ".png";
  }
