...
export class AccountsMenuComponent implements OnInit, AfterViewInit, OnDestroy {
...
public branchName:string;
  constructor(
    ...
    private menutotal:AccountsMenuService
  ) {
    ...
    this.menuItems=this.menutotal.getAccountsMenuMake();
