...
import { ROUTES  } from './prism-menu-routes.config';
...
@Component({
  selector: 'app-prism-menu',
  templateUrl: './prism-menu.component.html',
  styleUrls: ['./prism-menu.component.scss']
})
export class PrismMenuComponent implements OnInit {
...
public branchName:string;
  constructor(
    ...
    this.branchName=this.adm.getUserCompleteInformation().addr.branchName.substring(0,10);
