...
import { RouteInfo } from './inventory-menu.metadata';
...
public branchName:string;
 public cCode:number;
  ...
  constructor(
    ...
    private menu:InventoryMenuService,
    ...
    this.cCode=this.adm.getUserCompleteInformation().usr.cCode;

    this.branchName= usrinfo.usr.pCode + "_" + usrinfo.usr.vendor + ".png"; 
    
     this.menuItems=this.menu.getInventoryMenuMake();
