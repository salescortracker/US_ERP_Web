...
import { ROUTES, ROUTESOPTHA } from './qc-menu-routes.config';
...
@Component({
  selector: 'app-qc-menu',
  templateUrl: './qc-menu.component.html',
  styleUrls: ['./qc-menu.component.scss']
})
export class QCMenuComponent implements OnInit {
...
this.menuItems=this.qcm.getQCMenuMake();
 
//console.log(this.qcm.getQCMenuMake());
