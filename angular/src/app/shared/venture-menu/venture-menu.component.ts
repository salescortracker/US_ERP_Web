...
import { ROUTES,ROUTESAGENT } from './venture-menu-routes.config';
...
export class VentureMenuComponent implements OnInit {
...
public branchName:string;
  constructor(
    ...
    this.menuItems= usr.rCode.toUpperCase()=="AGENT"?ROUTESAGENT: ROUTES;
