...
@Component({
  selector: 'app-ppc-rep-material-requirement',
  templateUrl: './ppc-rep-material-requirement.component.html',
  styleUrls: ['./ppc-rep-material-requirement.component.scss']
})
export class PpcRepMaterialRequirementComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.ppc.getPPCRepMaterialRequirement().subscribe(
      async res => {
        var det:any=res;
