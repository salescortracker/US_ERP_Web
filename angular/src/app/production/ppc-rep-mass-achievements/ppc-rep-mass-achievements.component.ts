...
@Component({
  selector: 'app-ppc-rep-mass-achievements',
  templateUrl: './ppc-rep-mass-achievements.component.html',
  styleUrls: ['./ppc-rep-mass-achievements.component.scss']
})
export class PpcRepMassAchievementsComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.ppc.getPPCRepMassPlanningStatus().subscribe(
      async res => {
        var det:any=res;
