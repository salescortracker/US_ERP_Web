...
@Component({
  selector: 'app-ppc-rep-material-costing',
  templateUrl: './ppc-rep-material-costing.component.html',
  styleUrls: ['./ppc-rep-material-costing.component.scss']
})
export class PpcRepMaterialCostingComponent implements OnInit {
  public details:any;
  ...
  listAdd()
  {
    ...
    this.ppc.getPPCRunningBatchMaterialDetails().subscribe(
      async res => {
        var det:any=res;
