...
@Component({
  selector: 'app-dashboard-edificio',
  templateUrl: './dashboard-edificio.component.html',
  styleUrls: ['./dashboard-edificio.component.scss']
})
export class DashboardEdificioComponent implements OnInit,AfterViewInit {
