...
@Component({
  selector: 'app-mis-inbox',
  templateUrl: './mis-inbox.component.html',
  styleUrls: ['./mis-inbox.component.scss']
})
export class MisInboxComponent implements OnInit, AfterViewInit, OnDestroy {
